    ...
    while (!q.empty()) {
        ...
        ///Move 1
            ...
            if (a.second == b.second) {
                if (a.first > b.first) maxReach = b.first+1;
            }
            //If 3 is in the way; both same column
            if (a.second == c.second) {
                if (a.first > c.first) maxReach = c.first+1;
            }
            ...
            if (a.first == b.first) {
                if (a.second > b.second) maxReach = b.second+1;
            }
            //If 3 is in the way; both same row
            if (a.first == c.first) {
                if (a.second > c.second) maxReach = c.second+1;
            }
            //Push if not visited, mark as visited and label parent
        ...
        ///Move 2
            ...
            if (b.second == a.second) {
                if (b.first > a.first) maxReach = a.first+1;
            }
            //If 3 is in the way; both same column
            if (b.second == c.second) {
                if (b.first > c.first) maxReach = c.first+1;
            }
            //Push if not visited, mark as visited and label parent
            ...
            //If 2 is in the way; both same row
            if (b.first == a.first) {
                if (a.second > b.second) maxReach = a.second+1;
            }
            //If 3 is in the way; both same row
            if (b.first == c.first) {
                if (b.second > c.second) maxReach = c.second+1;
            }
            //Push if not visited, mark as visited and label parent
            ...
            //If 2 is in the way; both same row
            if (b.first == a.first) {
                if (b.second < a.second) maxReach = a.second-1;
            }
            //If 3 is in the way; both same row
            if (b.first == c.first) {
                if (b.second < c.second) maxReach = c.second-1;
        ...
        ///Move 3
            ...
            if (c.second == b.second) {
                if (c.first > b.first) maxReach = b.first+1;
            }
            //If 3 is in the way; both same column
            if (c.second == a.second) {
                if (c.first > a.first) maxReach = a.first+1;
            }
            //Push if not visited, mark as visited and label parent
            ...
            //If 2 is in the way; both same row
            if (c.first == b.first) {
                if (c.second > b.second) maxReach = b.second+1;
            }
            //If 3 is in the way; both same row
            if (c.first == a.first) {
                if (c.second > a.second) maxReach = a.second+1;
            }
            //Push if not visited, mark as visited and label parent
